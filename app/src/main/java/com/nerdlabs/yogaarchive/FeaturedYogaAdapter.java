...
public class FeaturedYogaAdapter extends RecyclerView.Adapter<FeaturedYogaAdapter.MyViewHolder> {
    ...
    public interface ListItemClickListener {
        void onfyListItemClick(int clickedItemIndex);
    }



    public FeaturedYogaAdapter(ArrayList<PosesModel> data, Context mContext, FeaturedYogaAdapter.ListItemClickListener listener){
    ...
    @Override
    public FeaturedYogaAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.category_list_item, parent, false);
        FeaturedYogaAdapter.MyViewHolder holder = new FeaturedYogaAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(FeaturedYogaAdapter.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mOnClickListener.onfyListItemClick(clickedPosition);
