...
public class CategoriesItemAdapter extends RecyclerView.Adapter<CategoriesItemAdapter.MyViewHolder> {
    ...
    public CategoriesItemAdapter(ArrayList<PosesModel> data, Context mContext, ListItemClickListener listener){
